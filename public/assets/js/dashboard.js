...
var handleInteractiveChart = function () {
	...
	if ($('#temperatura').length !== 0) {
        ...
        var data1 = [ 
            [1196472800000, 50], [1197154800000, 70], [1197241200000, 60], [1197414000000, 71], [1197846000000, 65], [1197932400000, 87], [1198537200000, 67], [1198623600000, 90],
        ...
        var plot = $.plot($("#temperatura"), 
            data1,  
            {
                ...
                yaxis: {  max: 30, min: 20,tickColor: 'rgba(0,0,0,0.2)', ticks: 5 },
                grid: { 
                    hoverable: true, 
                    clickable: true,
